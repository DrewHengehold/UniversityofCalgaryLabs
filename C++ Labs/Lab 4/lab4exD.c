...
/*  Duplicatesmy_strlen from <string.h>, except return type is int.
 *  REQUIRES
...
/*  Duplicatesmy_strncat from <string.h>, except return type is void.
...
/*  Duplicatesmy_strncmp from <string.h>, except return type is int.
 *  REQUIRES
